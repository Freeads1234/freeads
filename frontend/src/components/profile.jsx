...
const UserProfile = (props) => {
  ...
  const toggleModal = () => {
    props?.setShowUserModal(!props?.showUserModal);
  };
  ...
  return (
    <div className="overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center">
      ...
      {/* Profile Container */}
      <div className="relative mx-auto top-52 p-6 bg-gray-100 rounded-lg shadow-lg z-50 w-2/3">
      <button
                onClick={toggleModal}
                type="button"
                className="text-gray-400 text-end bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
              >
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"
        ...
        <div className="flex justify-start items-center w-full relative">
          ...
          <div
            className="w-36 h-36 left-7 top-10 bg-gray-100 border-2 border-dashed border-black rounded-lg flex items-center justify-center relative"
          ...
          <form className="mt-48 ">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="mt-1 block w-2/3 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              />
              <h1 className="text-2xl font-semibold my-6 text-gray-800">
                Change Password
              </h1>
